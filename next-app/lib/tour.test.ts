...
const JAN_ROUND: HistoryRound = {
  ...
  activeGames: { teamMultiplier: true, bestBall: false, worstBall: false, aggregate: false, skins: false, nassau: false, ctp: true, longDrive: true, wolf: false, gross: false, net: false },
  wolfOrder: [],
  wolfHoles: [],
...
const FEB_ROUND: HistoryRound = {
  ...
  activeGames: { teamMultiplier: false, bestBall: true, worstBall: false, aggregate: false, skins: false, nassau: false, ctp: true, longDrive: true, wolf: false, gross: false, net: false },
  wolfOrder: [],
  wolfHoles: [],
  courseName: 'Toronto',
  courseRating: 73,
